...
const Page = () => {
  const [numbers, setNumbers] = useState<number[]>([
    11, 12, -10, -18, -9, -14, 1, 300, 6, -5, 20, -18,
  ]);
  ...
  const resetQuiz = () => {
    setNumbers([11, 12, -10, -18, -9, -14, 1, 300, 6, -5, 20, -18]); // Reset the original numbers
    setSelectedNumbers1([]);
    setSelectedNumbers2([]);
    setSelectedNumbers3([]);
    setSelectedNumbers4([]);
        ...
        <div className="p-5 gap-5 flex flex-row bg-indigo-200 text-5xl">
          ...
          <div className="flex flex-col gap-2 justify-items-center text-center">
            <div
              ...
              className="p-5 bg-red-400 rounded text-center font-bold h-[4.4rem] w-[7.5rem] flex justify-center items-center"
            >
            ...
            <div
              ...
              onDragOver={handleDragOver}
              className="p-5 bg-green-400 rounded text-center font-bold h-[4.4rem] w-[7.5rem] flex justify-center items-center"
            >
              <div className="flex space-x-2">
            ...
            <div
              ...
              onDragOver={handleDragOver}
              className="p-5 bg-sky-400 rounded text-center font-bold h-[4.4rem] w-[7.5rem] flex justify-center items-center"
            >
              <div className="flex space-x-2">
            ...
            <div
              ...
              onDragOver={handleDragOver}
              className="p-5 bg-amber-400 rounded text-center font-bold h-[4.4rem] w-[7.5rem] flex justify-center items-center"
            >
              <div className="flex space-x-2">
            ...
            <div
              ...
              onDragOver={handleDragOver}
              className="p-5 bg-purple-400 rounded text-center font-bold h-[4.4rem] w-[7.5rem] flex justify-center items-center"
            >
              <div className="flex space-x-2">
          ...
          >
            {numbers.map((number, index) => (
              <div
                ...
                className="p-2 bg-blue-500 rounded cursor-pointer text-center w-[5rem] h-[4rem] text-4xl"
              >
                {number}
              </div>
            ))}
          ...
          <div className="flex flex-col gap-2">
            <button
              onClick={checkAnswer}
              className="bg-purple-600 rounded-md border-2 border-white px-5 py-1 h-[11.7rem]"
            >
              Cek Jawaban
            </button>
            <button
              onClick={resetQuiz}
              className="bg-rose-600 rounded-md border-2 border-white px-5 py-1 h-[11.7rem]"
            >
              Ulang Kuis
            </button>
          </div>
