...
const BAb4_Kuis_Page = () => {
  ...
  return (
    <div className="bg-sky-700 h-[40rem] w-[89.5rem] mt-[5rem] mx-2 mb-5 p-5 relative rounded-md left-[-90.9rem] text-3xl text-white flex justify-center items-center overflow-x-auto">
      <div className="bg-emerald-600 w-full h-full mx-auto rounded-md shadow-md text-justify">
        <h1 className="text-center text-5xl p-5 px-10 font-bold">KUIS BAB 3</h1>
        {/* garis green */}
        ...
        <div className="flex justify-center items-center">
          <button
            onClick={() => router.replace("/pagekuis/bab3_kuis")}
