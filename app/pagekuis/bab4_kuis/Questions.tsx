...
const Questions = () => {
  ...
  const calculatePoints = () => {
    ...
    updateDoc(ref, {
      bab4_kuis: totalPoints,
    })
      .then((response) => {
        console.log("success update bab4_kuis", response);
        alert("success update bab4_kuis");
      })
      .catch((error) => {
        console.log("failed update bab4_kuis", error);
        alert("failed update bab4_kuis");
      });
